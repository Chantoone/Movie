...
const promotions = [
    ...
    content: `
        ...
        <p>Chỉ cần mua vé xem phim tại ZCINEMA, bạn sẽ được nhận ngay 1 lon Pepsi mát lạnh hoàn toàn miễn phí!</p>
        ...
        <p>* Áp dụng tại tất cả các cụm rạp ZCINEMA trên toàn quốc.</p>
    `
}
,
    {
...
,
    ...
    content: `
        ...
        <p>Chỉ cần chụp ảnh check-in tại rạp ZCINEMA, đăng lên Facebook cá nhân ở chế độ công khai kèm hashtag #ZCINEMA, bạn sẽ nhận ngay 1 phần nước miễn phí.</p>
...
,
    ...
    content: `
        ...
        <p>* Áp dụng tại tất cả các rạp ZCINEMA toàn quốc.</p>
    `
}
...
const news = [
    ...
    content: `
        ...
        <p>Đặt vé ngay hôm nay tại ZCINEMA để nhận ngay combo ưu đãi siêu hot!</p>
    `
}
,
    {
    id: 2,
    title: "ZCINEMA Khai Trương Rạp Mới Tại Đà Nẵng",
    date: "15/12/2024",
    image: "../asset/image/new2.jpg",
    content: `
        <h2>CHÀO MỪNG ZCINEMA ĐÀ NẴNG - ƯU ĐÃI NGẬP TRÀN</h2>
        <p>ZCINEMA chính thức khai trương cụm rạp hiện đại tại Vincom Đà Nẵng với 6 phòng chiếu đạt chuẩn quốc tế.</p>
...
,
    ...
    content: `
        <h2>LỊCH CHIẾU PHIM TẾT 2025 ĐÃ CÓ TRÊN ZCINEMA</h2>
        <p>Khách hàng có thể đặt vé sớm cho các suất chiếu Tết từ ngày 10/12/2024 tại toàn bộ hệ thống ZCINEMA.</p>
...
,
    {
    id: 4,
    title: "Ưu Đãi Đặc Biệt Cho Thành Viên ZCINEMA",
    date: "05/12/2024",
    image: "../asset/image/new4.jpg",
    content: `
        <h2>THÀNH VIÊN ZCINEMA ƯU ĐÃI LÊN ĐẾN 50%</h2>
        <p>Từ 05/12, tất cả thành viên ZCINEMA sẽ được giảm giá vé, nhận quà sinh nhật và điểm thưởng khi đặt vé trực tuyến.</p>
...
,
    {
    id: 5,
    title: "Sự Kiện Cosplay Phim Hoạt Hình Tại ZCINEMA",
    date: "01/12/2024",
    image: "../asset/image/new5.jpg",
    content: `
        <h2>ĐÊM COSPLAY CỰC CHẤT - NHẬN VÉ MIỄN PHÍ!</h2>
        <p>Đến ZCINEMA trong trang phục cosplay các nhân vật hoạt hình yêu thích và nhận ngay vé xem phim miễn phí cho buổi chiếu đặc biệt ngày 01/12.</p>
        <p>Sự kiện giới hạn số lượng – chỉ áp dụng tại ZCINEMA Landmark và Vincom Center.</p>
    `
}
